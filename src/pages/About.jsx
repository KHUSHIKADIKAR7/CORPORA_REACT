...
// Section 2 Image
const imgVisionGrowth = `${import.meta.env.BASE_URL}Other images/about-vision-growth.jpg`;

// Section 5 Image
const imgPharmaTraining = `${import.meta.env.BASE_URL}Other images/pharma-traning.png.jpg`;
